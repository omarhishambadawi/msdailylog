...
SET permissions = ARRAY(SELECT unnest(permissions) EXCEPT SELECT unnest(ARRAY['view_workforce','manage_workforce']))
WHERE permissions && ARRAY['view_workforce','manage_workforce'];