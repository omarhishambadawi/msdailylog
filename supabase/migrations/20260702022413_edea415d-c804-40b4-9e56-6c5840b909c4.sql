...
AS $$
  SELECT EXISTS (
    ...
    WHERE user_id = _user_id AND role IN ('admin'::public.app_role, 'owner'::public.app_role)
  )
$$;

GRANT EXECUTE ON FUNCTION public.is_administrator(uuid) TO authenticated, anon, service_role;
